    ...
    $html = '<div class="contact-form' . ( $el_class != '' ? ' ' . $el_class : '' ) . '">
    	...
    	if ( sizeof( $subject_arr ) == 1 ) {
    		$html .= '<div class="block">
    			<label class="screen-reader">' . __( 'asunto *', 'lobo' ) . '</label>
