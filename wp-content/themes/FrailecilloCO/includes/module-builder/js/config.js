		...
		// Gallery 
		{
			...
			options: generalOptions.concat( Array(
				...
				// Label
				{
					...
					type: 'text',
					title: 'Label',
					description: 'An optional title label for the module containing the gallery. If left empty, the default value will be "View Gallery".',
					std: ''
				},
				...
				// Overlay
				{
					...
					type: 'select',
					title: 'Overlay',
					description: 'You can completely disable the module\'s overlay.',
					std: 'yes',
					choices: Array(
						{
							label: 'Display',
