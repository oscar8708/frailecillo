  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        ...
        'desc'        => '
<strong>v2.3.1 // updated: 02/26/15</strong>   
<ul>
<li>Added support for WooCommerce grouped projects</li>
<li>Fixed alternate portfolio filtering</li> 
<li>Fixed an issue with WooCommerce checkout</li>
</ul>
<br><strong>v2.3 // updated: 02/12/15</strong>
<ul>
<li>Added support for WooCommerce 2.3</li>
<li>Added social meta tags in the header</li>
<li>Added a "related projects" module</li>
<li>Added a "please update message" for IE8 users</li>
<li>Updated Font Awesome to v4.3 (Lobo Shortcodes update)</li>
<li>Fixed a minor localization issue</li>
<li>Fixed an error related to WooCommerce products with no description</li>
</ul>
<br><strong>v2.2.2 // updated: 01/22/15</strong>
<ul>
<li>Fixed a bug related to self hosted videos in WP 4.1</li>
</ul>
<br /><strong>v2.2.1 // updated: 12/23/14</strong>
<ul>
<li>Made theme ready for WP 4.1</li>
<li>Fixed a bug related to portfolio & touch devices</li>
<li>Fixed an issue with lightbox design on retina displays</li>
</ul>
<br /><strong>v2.2 // updated: 12/13/14</strong>
<ul>
