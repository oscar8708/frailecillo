        ...
        <div class="comments-wrapper">
			...
			<?php 
				...
				$defaults = array( 'fields' => apply_filters( 'comment_form_default_fields', array(
					...
					'logged_in_as' => '<p style="margin-bottom:25px" class="logged-in-as">' . sprintf( __( 'You are logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>', 'lobo' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>',
